...
'''
    ...
    stage('Notification') {
      steps {
        ...
        jiraNotifyIssue(auditLog: true, idOrKey: 'MTRA', notify: 'd0p3k9t4x3h8n1b3@bestbuy.slack.com', failOnError: true, site: 'https://prasadacn.atlassian.net/projects/MTRA/issues')
      }
    }
